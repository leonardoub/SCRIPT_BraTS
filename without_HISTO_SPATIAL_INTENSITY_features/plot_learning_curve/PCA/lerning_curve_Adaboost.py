...
clf_opt=AdaBoostClassifier(base_estimator=base_est, algorithm='SAMME.R', n_estimators =100, learning_rate=0.5, random_state=503)

pca = PCA(n_components=0.85, random_state=42)

steps_opt = [('scaler', MinMaxScaler()), ('red_dim', None), ('clf', clf_opt)]
