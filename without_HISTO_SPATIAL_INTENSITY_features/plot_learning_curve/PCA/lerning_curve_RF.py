...
clf_opt=RandomForestClassifier(class_weight='balanced', criterion='entropy', n_estimators=100, max_depth=10, min_samples_leaf=2, min_samples_split=10, random_state=503)
