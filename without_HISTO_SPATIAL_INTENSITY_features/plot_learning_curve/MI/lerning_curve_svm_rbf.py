...
steps = [('scaler', StandardScaler()), ('red_dim', SelectPercentile(mutual_info_classif, percentile=10)), ('clf', clf)]
...
clf_opt=SVC(C=128, gamma=0.001953125, kernel='rbf')

steps_opt = [('scaler', StandardScaler()), ('red_dim', SelectPercentile(mutual_info_classif, percentile=10)), ('clf', clf_opt)]
