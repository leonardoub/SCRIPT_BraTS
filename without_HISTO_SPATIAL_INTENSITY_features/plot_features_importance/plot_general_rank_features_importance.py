...
path_summary_ANOVA_features = '/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /ANOVA_best_features/AdaBoost/ANOVA_summary/summary_feature_ANOVA_RSoKF_2.csv'
...
path_summary_RF_features = '/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /best_feature_importances_for_RandomForest/RF_summary/summary_feature_RF_RSoKF2.csv'
data_feat_RF = pd.read_csv(path_summary_RF_features, index_col=0) 

path_summary_svml_MMS_features = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /best_feature_importances_for_svm_lin/svml_summary_{scaler_svml}/summary_feature_svml_{scaler_svml}_RSoKF_2.csv'
