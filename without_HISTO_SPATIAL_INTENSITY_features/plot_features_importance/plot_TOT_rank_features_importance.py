...
# -*- coding: utf-8 -*-
"""
Created on Sun May 31 22:17:16 2020
...
for scaler_svml in scaler_svml_list: 
    ...
    path_summary_ANOVA_features = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /ANOVA_best_features/AdaBoost/ANOVA_rank_tot/rank_tot_feature_ANOVA.csv'
    data_feat_ANOVA = pd.read_csv(path_summary_ANOVA_features, index_col=0) 
    
    path_summary_MI_features = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /MUTUAL_INFO_best_features/AdaBoost/MUTUAL_INFO_rank_tot/rank_tot_feature_MUTUAL_INFO.csv'
    data_feat_MI = pd.read_csv(path_summary_MI_features, index_col=0) 
    
    path_summary_RF_features = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /best_feature_importances_for_RandomForest/RF_rank_tot/rank_tot_feature_RF.csv'
    data_feat_RF = pd.read_csv(path_summary_RF_features, index_col=0) 
    
    path_summary_svml_MMS_features = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /best_feature_importances_for_svm_lin/svml_{scaler_svml}_rank_tot/rank_tot_feature_svml_{scaler_svml}.csv'
    ...
    outname = f'TOT_rank_features_importance_with_svml_{scaler_svml}.png'
    
    outdir = f'/home/leonardo/Scrivania/scrittura_TESI/img/original/without_HISTO_SPATIAL_INTENSITY/'
