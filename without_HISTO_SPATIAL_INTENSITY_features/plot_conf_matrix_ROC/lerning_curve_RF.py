...
clf_opt=RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_leaf=1, min_samples_split=5, random_state=503)

steps_opt = [('scaler', None), ('red_dim', None), ('clf', clf_opt)]

pipeline_opt = Pipeline(steps_opt)

title = "Learning Curves (RandomForestClassifier Optimized)"
