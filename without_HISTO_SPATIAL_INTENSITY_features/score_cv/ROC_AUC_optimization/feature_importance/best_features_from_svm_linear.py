...
# -*- coding: utf-8 -*-
"""
Created on Sun May 24 13:11:05 2020
...
for scaler in scaler_list:
        ...
        for j in range(1,6):
            ...
            path = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /best_feature_importances_for_svm_lin/features_importance_for_svm_lin_scaler_{scaler}_dim_red_NONE_BEST_HP_RSoKF_{2*j}.csv'
            ...
            outdir = f'/home/leonardo/Scrivania/result_brats/05_30/important_features_05_30/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /best_feature_importances_for_svm_lin/svml_summary_{scaler}/'
