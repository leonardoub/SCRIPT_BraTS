...
def function_save_features_selected_ANOVA(dimensionality_reduction, name_clf, features, best_est_dictionary):
    ...
    for key, value in best_est_dictionary.items():
        ...
        outdir = f'/home/users/ubaldi/TESI_BRATS/result_CV/nested_CV/data_without_HISTO_SPATIAL_INTENSITY/ROC_AUC_optimization/{name_clf}_stability/{name_clf}_features_selected_ANOVA'
