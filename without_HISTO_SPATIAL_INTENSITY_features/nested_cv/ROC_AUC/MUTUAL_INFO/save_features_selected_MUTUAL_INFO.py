...
def function_save_features_selected_MUTUAL_INFO(dimensionality_reduction, name_clf, features, best_est_dictionary, rs_outer_kf):
    ...
    for key, value in best_est_dictionary.items():
        ...
        p_values = value.named_steps['red_dim'].scores_[0]
    ...
    outdir = f'/home/users/ubaldi/TESI_BRATS/important_features/data_without_HISTO_SPATIAL_INTENSITY/score_ROC_AUC_optimization /MUTUAL_INFO_best_features/{name_clf}/'
