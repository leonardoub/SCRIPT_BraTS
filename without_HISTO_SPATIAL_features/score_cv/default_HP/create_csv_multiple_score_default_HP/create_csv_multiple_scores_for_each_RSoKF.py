...
for i in range(1,6):
    ...
    path_score_default_HP = f'/home/leonardo/Scrivania/result_brats/05_30/score_ROC_AUC_default_HP_05_30/data_without_HISTO_SPATIAL/score_default_HP/RS_outer_KF_{i*2}/*.csv'
    ...
    outname = f'summary_scores_default_HP_without_HISTO_SPATIAL_RSoKF_{i*2}.csv'
    
    outdir = f'/home/leonardo/Scrivania/result_brats/05_30/score_ROC_AUC_default_HP_05_30/data_without_HISTO_SPATIAL/score_default_HP/'
