...
def function_save_output(final_data, dimensionality_reduction, name_clf):
    ...
    outdir = f'/home/users/ubaldi/TESI_BRATS/important_features/data_without_HISTO_SPATIAL/score_ROC_AUC_optimization/{name_clf}_stability/best_feature_importances_for_{name_clf}'
