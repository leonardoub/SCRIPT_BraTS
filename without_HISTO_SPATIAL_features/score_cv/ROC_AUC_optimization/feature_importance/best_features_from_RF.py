...
for j in range(1,6):
    ...
    path = f'/home/leonardo/Scrivania/result_brats/important_features_05_24/data_without_HISTO_SPATIAL/score_ROC_AUC_optimization/best_feature_importances_for_RandomForest/features_importance_for_RandomForest_scaler_VARIABLE_dim_red_NONE_BEST_HP_RSoKF_{2*j}.csv'
