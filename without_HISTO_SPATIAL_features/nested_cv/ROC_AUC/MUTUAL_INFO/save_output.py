...
def function_save_output(final_data, dimensionality_reduction, name_clf, rs_outer_kf):
    ...
    outdir = f'/home/users/ubaldi/TESI_BRATS/result_CV/nested_CV/data_without_HISTO_SPATIAL/ROC_AUC_optimization/{name_clf}_stability/RS_outer_KF_{rs_outer_kf}/'
