...
#AdaBoost
steps = [('scaler', MinMaxScaler()), ('red_dim', SelectPercentile()), ('clf', AdaBoostClassifier(random_state=503))]

pipeline = Pipeline(steps)

parameteres = [{'scaler':scalers_to_test, 'red_dim':[SelectPercentile()], 'red_dim__percentile':n_features_to_test,
